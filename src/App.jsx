      ...
      <div className='app-main'>
        ...
        {showForm && (
          <form onSubmit={handleForm}>
            <h3>Add Card Form</h3>
            <input type="text" placeholder='Enter Post URL' onChange={(e)=>{setFormData({...formData, postImg: e.target.value})}} required/>
            <input type="text" placeholder='Enter Profile URL' onChange={(e)=>{setFormData({...formData, profileImg: e.target.value})}} required/>
